    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            struct pixel_t
            {
                ...
                float2 softMaskUV : TEXCOORD6; // AMS UI Soft Mask UV
            };
            ...
            pixel_t VertShader(vertex_t input)
            {
                ...
                output.viewDir = mul((float3x3)_EnvMatrix, _WorldSpaceCameraPos.xyz - wPos.xyz);
                #if (UNDERLAY_ON || UNDERLAY_INNER)
            ...
            fixed4 PixShader(pixel_t input) : SV_Target
            {
                ...
                //AMS UI Soft Mask
                #ifdef _DEBUG_MASK
					return DebugMask(input.softMaskUV, _SoftMask).r * faceColor.a;
                #else
                faceColor.a = UISoftMask(input.softMaskUV, _SoftMask, faceColor.a);
                #endif
